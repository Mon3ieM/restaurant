...
public class PDFExporter {
	...
	private static void createNewCell(PdfPTable table, Color bkClr, Color brdClr, int padding, String data, Font font , int alignment) {
	...
	private static void preparTitle(Document document, CheuqeDTO dto, BaseFont bf) {
		...
		Font font_Table_Data2 = new Font(bf, 4);
		font_Table_Data2.setColor(Color.BLACK);
		createNewCell(table, Color.WHITE, Color.WHITE, 1,"شلتــــــــــــــــــــــــــــــوت", font_Table_Data,PdfPCell.ALIGN_CENTER);
		createNewCell(table, Color.WHITE, Color.WHITE, 1, "(دوق واحكم)", font_Table_Data2,PdfPCell.ALIGN_CENTER);
		createNewCell(table, Color.WHITE, Color.WHITE, 1, "01101142636-01090903164", font_Table_Data2,PdfPCell.ALIGN_CENTER);
	...
	private static void preparHeaderData(Document document, CheuqeDTO dto, BaseFont bf)
		...
		Font font_Table_Data = new Font(bf, 5);
		font_Table_Data.setColor(Color.BLACK);

		createNewCell(table, Color.WHITE, Color.WHITE, 1, "رقم : ", font_Table_Data,PdfPCell.ALIGN_LEFT);
		createNewCell(table, Color.WHITE, Color.WHITE, 1, dto.getOrder().getId() + "", font_Table_Data,PdfPCell.ALIGN_LEFT);

		createNewCell(table, Color.WHITE, Color.WHITE, 1, "أسم : ", font_Table_Data,PdfPCell.ALIGN_LEFT);
		createNewCell(table, Color.WHITE, Color.WHITE, 1, dto.getClient().getName(), font_Table_Data,PdfPCell.ALIGN_LEFT);

		createNewCell(table, Color.WHITE, Color.WHITE, 1, "العنوان : ", font_Table_Data,PdfPCell.ALIGN_LEFT);
		createNewCell(table, Color.WHITE, Color.WHITE, 1, dto.getClient().getAddress(), font_Table_Data,PdfPCell.ALIGN_LEFT);

		createNewCell(table, Color.WHITE, Color.WHITE, 1, "موبيل : ", font_Table_Data,PdfPCell.ALIGN_LEFT);
		createNewCell(table, Color.WHITE, Color.WHITE, 1, dto.getClient().getMobile1(), font_Table_Data,PdfPCell.ALIGN_LEFT);

		createNewCell(table, Color.WHITE, Color.WHITE, 1, "الكاشير : ", font_Table_Data,PdfPCell.ALIGN_LEFT);
		createNewCell(table, Color.WHITE, Color.WHITE, 1, dto.getUser().getUserName(), font_Table_Data,PdfPCell.ALIGN_LEFT);
	...
	private static void preparTableData(Document document, CheuqeDTO dto, BaseFont bf)
		...
		Font font_Table_Header = new Font(bf, 7);
		font_Table_Header.setColor(Color.WHITE);
		...
		for (FoodItemDataDTO d : list) {
			...
			createNewCell(table, Color.WHITE, Color.BLACK, 5, d.getFoodMenuName(), font_Table_Data,PdfPCell.ALIGN_CENTER);
			createNewCell(table, Color.WHITE, Color.BLACK, 5, d.getQty() + "", font_Table_Data,PdfPCell.ALIGN_CENTER);
			createNewCell(table, Color.WHITE, Color.BLACK, 5, d.getPrice() + "", font_Table_Data,PdfPCell.ALIGN_CENTER);
			createNewCell(table, Color.WHITE, Color.BLACK, 5, d.getQty() * d.getPrice() + "", font_Table_Data,PdfPCell.ALIGN_CENTER);
...
//		table.setSpacingBefore(10);
	...
	private static void preparFooter(Document document, CheuqeDTO dto, BaseFont bf) {
		...
		Font font_Table_Footer_Company = new Font(bf, 3);
		font_Table_Footer_Company.setColor(Color.BLACK);

		Font font_Table_Footer = new Font(bf, 6);
		font_Table_Footer.setColor(Color.WHITE);
		
		createNewCell(table, Color.GRAY, Color.WHITE, 5, " الاجمالى : ",
				font_Table_Footer,PdfPCell.ALIGN_CENTER);
		createNewCell(table, Color.GRAY, Color.WHITE, 5,  dto.getOrder().getTotalPrice() + "  جنيه",
				font_Table_Footer,PdfPCell.ALIGN_CENTER);

		
		
		createNewCell(table, Color.WHITE, Color.WHITE, 5, "شركة Semi;Colon للبرمجيات ", font_Table_Footer_Company,PdfPCell.ALIGN_CENTER);
		createNewCell(table, Color.WHITE, Color.WHITE, 5, "01276867578  -  01110562621", font_Table_Footer_Company,PdfPCell.ALIGN_CENTER);
	...
	public static void printCheque(CheuqeDTO dto) throws DocumentException, PrintException {
		try {
			...
			pdDocument = PDDocument.load(new File(pathChq));
